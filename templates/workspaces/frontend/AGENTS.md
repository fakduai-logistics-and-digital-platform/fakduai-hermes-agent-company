...
- Runtime must load every Markdown file under `skills/taste-skill/` before frontend visual/UI implementation, including all `SKILL.md`, `DESIGN.md`, README, and research notes.
